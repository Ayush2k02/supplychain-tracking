...
describe('Starting tests for supplychain-network-app', function() {
  ...
  it('website title should be supplychain-network-app', () => {
    page.navigateTo('/');
    return browser.getTitle().then((result)=>{
      expect(result).toBe('supplychain-network-app');
    })
  });
  ...
  it('navbar-brand should be supplychain-network-app',() => {
    element(by.css('.navbar-brand')).getWebElement()
    .then((webElement) => {
      return webElement.getText();
    })
    .then((txt) => {
      expect(txt).toBe('supplychain-network-app');
    });
  });
